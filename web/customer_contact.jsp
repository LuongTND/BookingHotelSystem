<%-- 
    ...
    Created on : May 30, 2023, 12:35:58 AM
    Author     : TuaSan
--%>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="contact_info">
                            ...
                            <div class="info_item">
                                ...
                                <h6><a href="#">g2hotel@gmail.com</a></h6>
                    ...
                    <div class="col-md-9">
                        ...
                        <form class="row contact_form" action="contact" method="get" onsubmit="return confirmSendMessage();" >
        ...
        <script>
            function confirmSendMessage() {
                var confirmation = confirm("Do you want to send a message?");
