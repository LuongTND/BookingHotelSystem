...
<html lang="en">
    ...
    <body>
        ...
        <div class="containerfb">
            ...
            <h3 style="color: green; text-align: center;" >${mess} </h3>
            <c:if test="${requestScope.check == 0}"> 
                <h5 style="color: red; text-align: center;" >You cannot review until you have completed the booking.</h5>
            </c:if>
            <c:if test="${requestScope.check != 0}"> 
                <form action="feedback" method="POST" id="feedback-form">
                    ...
                    <input type="hidden" class="form-control mt-1" id="FullName" name="FullName" value="${userA.getFullName()}">
                    <div class="mb-3">
                ...
                <c:forEach var="feedback" items="${requestScope.LIST_EXIST_FEEDBACK}">
                    <div class="comment">
                        ...
                        <div class="comment-content">
                            ...
                            <div>
                                <div class="comment-name">${feedback.getCustomerName()}</div>
                                <div class="comment-rating">
                                    <span class="badge bg-primary">${feedback.getRating()} sao</span>
                                </div>
                                <p class="comment-text">${feedback.getContent()}</p>
                            </div>
                        </div>
                        <!-- Show reply comment if it exists -->

                        <c:if test="${feedback.getAdminReply() != null}">
                            <div class="comment-reply">
                                <div class="comment-reply-content">
                                    <div class="comment-name">Admin</div>
                                    <p class="reply-text">${feedback.getAdminReply()}</p>
                                </div>
                            </div>
                        </c:if>
                    </div>
