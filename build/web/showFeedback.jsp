    ...
    <body>
        ...
        <div class="containerfb">
            ...
            <table>
                ...
                <c:forEach items="${requestScope.LIST_ADMIN_FFEDBACK}" var="feedback">
                    <tr>                       
                        <td>${feedback.getCustomerName()}</td>
                        <td>${feedback.getTimeFeedback()}</td>
                        <td>${feedback.getContent()}</td>
                        <td>${feedback.getRating()}</td>   
                        <td>${feedback.getReplyStatus()}</td>

                        <td class="actions" style="text-align: center">
                            <!--<button class="button btn-secondary" onclick="openPopupReply()">Reply</button>-->      
                            <button class="button btn-secondary" onclick="openPopupDelete('${feedback.getIDFeedback()}')">Reply</button> 
                        </td>
                    </tr>
                </c:forEach>
            </table>
