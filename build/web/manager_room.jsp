...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="room-item shadow rounded overflow-hidden">
                                ...
                                <div class="p-4 mt-2">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a class="btn btn-sm btn-dark rounded py-2 px-4" href="delete?IDRoomType=${room.getIDRoomType()}" onclick="return confirmSendMessage();">Delete</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
        ...
        <form action="addNewRoomType" class="col-md-9 m-auto" method="get" role="form">
            <div class="row">
