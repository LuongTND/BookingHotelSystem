    ...
    <body>
        ...
        <table style="margin-top: 20px;margin-bottom: 20px;" id="booking">
            ...
            <c:forEach items="${sessionScope.listD}" var="l">
                <tr>
                    ...
                    <td>${l.getEndDay()}</td>
                    <td>${l.getNote()}</td>
                    <td><a href="loadDiscountToEdit?IDDiscount=${l.getIDDiscount()}">Edit</a> | <a href="delete?IDDiscount=${l.getIDDiscount()}" onclick="return confirmDelete();">Delete</a></td>
                </tr>
            </c:forEach>
        ...
        <form action="addNewDiscount" class="col-md-9 m-auto" method="get" role="form">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control mt-1" id="Note" name="Note" placeholder="Code" required>
                </div>
            </div>
            <div class="row">
        ...
        <script>
            function confirmDelete() {
                ...
                // Nếu người dùng nhấn OK (đồng ý xóa), tiếp tục chuyển đến liên kết "delete"
                if (confirmation) {
                    return true;
                }
                // Nếu người dùng nhấn Cancel (không xóa), hủy chuyển đến liên kết "delete"
                else {
                    return false;
                }
            }
