        ...
        <form action="searchBooking" method="get">
            <div class="container">
                <div class="row hotel_booking_table">
                    ...
                    <div class="col-md-9">
                        <input class="col-md-12" type="text" id="BookingCode" name="BookingCode" placeholder="BookingCode">
        ...
        <table style="margin-top: 20px;margin-bottom: 20px;" id="booking">
            ...
            <tbody>
                ...
                <form action="updateBookingStatus" method="get">
                    ...
                    <td><input type="submit" value="${b.getNote()}" onclick="return confirmSendMessage();"></a></td>
                    <!--</form>-->
