...
public class RoomType {
    ...
    public String toString() {
        return "RoomType{" + "IDRoomType=" + IDRoomType + ", NameRoomType=" + NameRoomType + ", MaxPerson=" + MaxPerson + ", NumberOfBed=" + NumberOfBed + ", NumberOfBath=" + NumberOfBath + ", Price=" + Price + ", totalRoom=" + totalRoom + ", RoomStatus=" + RoomStatus + ", Content=" + Content + '}';
    }
