...
public class AddNewRoomTypeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddNewRoomTypeServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddNewRoomTypeServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        String IDRoomType = request.getParameter("IDRoomType");
        ...
        manadao.addRoomType(name, maxPerson, numberOfBed, numberOfBath, price, totalRoom, status, content);
