...
public class FeedbackDAO {
    ...
    // lấy danh sách feedback từ dataabase
    public List<Feedback> getLastFiveFeedback() {
        ...
        try {
            ...
            String query = "select top 5 f.IDFeedback, f.IDAccount, IDBooking, TimeFeedBack, ReplyContent, Rating, FullName, f.Content, a.UserName\n"
    ...
    public List<Feedback> getAllFeedback() {
        ...
        try {
            ...
            String query = "select IDFeedback, f.IDAccount, IDBooking, TimeFeedBack, Content, Rating, FullName, Active\n"
                    + "from Feedback f join Account a on f.IDAccount = a.IDAccount\n"
                    + "where Active = 1";
            ...
            while (rs.next()) {
                ...
                list.add(new Feedback(feedbackId, bookingId, accountId, accountName, feedbackDate, content, rating, active));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public boolean insertFeedback(Feedback feedback) {
        try {
            ...
            String query = "insert Feedback(IDAccount,Content,TimeFeedBack,Rating,Active) values (?,?,?,?,1)";
